 ...
 for (timePassed=1; timePassed<totTime; timePassed++) {     
  for (elemCount=0; elemCount<divs*divs*divs; elemCount++) {                     
   ...
   if (elemCount <= divs*divs-1 || elemCount >= divs*divs*(divs-1)) {
    elemConc[elemCount]= 47; //for front and back faces   
    elemConcMaster[elemCount+(timePassed-1)*divs*divs*divs] = 47;
   } 
                     
   for (j=0; j<divs; j++) {    
    for (k=0; k<divs*divs; k++) {
     if (k<divs) {
      elemConc[j*divs*divs+k*divs]= 47;  //for left face
      elemConcMaster[j*divs*divs+k*divs+(timePassed-1)*divs*divs*divs]= 47;

      elemConc[j*divs*divs+k*divs+divs-1] = 47;  //for right face
      elemConcMaster[j*divs*divs+k*divs+divs-1+(timePassed-\
       1)*divs*divs*divs]=47;

      elemConc[j*divs*divs+k] = 47; //for bottom face
      elemConcMaster[j*divs*divs+k+(timePassed-1)*divs*divs*divs] = 47;
     }
     else if (k >= divs*(divs-1)) {
      elemConc[j*divs*divs+k]= 47; //for top face
      elemConcMaster[j*divs*divs+k+(timePassed-1)*divs*divs*divs] = 47;
     }
    }
   }
  ...
  //for the 2nd layer.           
   for (z=0; z<scndLayerCount;z++){
    for (y=0; y<scndLayerCount;y++){
     elemConc[(divs*(divs+z+1)+(y+1))+(timePassed-1)*divs*divs*divs] = maxConc;   //2nd layer front face                              
     ...
     if (z==0 && y==0){
      ...
      for (v=0;v<scndLayerCount;v++){
       for (p=0; p<scndLayerCount;p++){
        ...
        elemConcMaster[divs*(divs+1)+1+v+p_r+(timePassed-1)*divs*divs*divs]=maxConc = maxConc; 
       }
      }
     ...
     if (z==(scndLayerCount-1) && y==0){
      for (int f=0;f<z;f++){
       for (int g=0; g<scndLayerCount;g++){
